...
{
    public abstract class abp_angularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static abp_angularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(abp_angularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<abp_angularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<abp_angularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<abp_angularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<abp_angularDbContext, Task<T>> func)
        {
            T result;
